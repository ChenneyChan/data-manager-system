...
using static ABBDataManagerSystem.Connector.JinYuan50ECollectorV1;
...
namespace ABBDataManagerSystem.Pages
{
    ...
    /// </summary>
    public partial class JinYuan50E : UserControl, ICloseable
    {
        private bool IsSimulate = false;
        private Random random = new Random();
        private bool IsFirstLoaded = true;
        private JinYuan50ECollectorV1? Collector = null;
        ...
        private Dictionary<TestType50E, ToggleButton> testTypeToggleButtons = new Dictionary<TestType50E, ToggleButton>();
        ...
        private TestType50E? SelectedTesting = TestType50E.Normal;
        ...
        private JinYuan50ECollectorV1.CommonPacket? lastPacket = null;
        ...
        public JinYuan50E()
        {
            ...
            var patterns = JinYuan50ECollectorV1.EnumHelper.patternMap.Values;
        ...
        private void InitToggleButtons()
        {
            ...
            testTypeToggleButtons.Add(TestType50E.Normal, tbTestTypeCommon);
            testTypeToggleButtons.Add(TestType50E.TemperatureRise10Sec, tbTestTypeTempRise10s);
            testTypeToggleButtons.Add(TestType50E.TemperatureRise30Sec, tbTestTypeTempRise30s);
            testTypeToggleButtons.Add(TestType50E.TemperatureRise60Sec, tbTestTypeTempRise60s);
        }
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            for (int i = 0; i < ports.Length; i++)
            {
                ...
                if (item == Configs.Configs.SerialPort50E)
                {
                    selectedIndex = i;
                }
            }
        ...
        private void swConnect_CheckedChange(object sender, RoutedEventArgs e)
        {
            ...
            {
                IsConneted = true;
                Configs.Configs.SerialPort50E = cbSerialPort.Text;
                Collector = new JinYuan50ECollectorV1(cbSerialPort.SelectedItem.ToString(), Utils.ParseInt(cbBoundRate.Text));
        ...
        private void StartSyncState()
        {
            ...
            new Thread(() =>
            {
                ...
                {
                    CollectDataOnce();
                    if (ResetEvent.WaitOne(JinYuan50ECollectorV1.Interval))
                    {
                        // 线程没有超时被唤醒，说明要停止循环了
                    }
                }
        ...
        private void cb20E_ComboBox_ConfigChanges(object sender, RoutedEventArgs e)
        {
            ...
            if (cb20EPatterns.SelectedItem.ToString() != "单通道" || SelectedTesting != TestType50E.Normal)
            {
        ...
        {
            string testType = SelectedTesting == TestType50E.Normal ? "常规" : "温升";
        ...
        private void UpdateRealTimePanelDisplay(JinYuan50ECollectorV1.CommonPacket packet)
        {
        ...
        private void TestTypeSelectedTappingChange(object sender, RoutedEventArgs e)
        {
            ...
            if (b.IsChecked)
            {
                ...
                {
                    SelectedTesting = TestType50E.Normal;
                    IsTempRiseCool = true;
                }
                else
                {
            ...
            else if (SelectedTesting == TestType50E.Normal)
            {
